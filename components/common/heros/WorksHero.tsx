  ...
  return (
    <section className="relative w-full h-[540px] overflow-hidden flex flex-col items-center justify-center text-center px-4">
      <div
        ...
        style={{
          backgroundImage: "url('/hero/worksHero.jpg')",
        }}
      />
      ...
      <div className="relative z-20 max-w-[912px] mx-auto flex flex-col items-center text-white h-full justify-center">
        ...
        <p className="text-base md:text-[18px] leading-[26px] font-normal font-inter text-gray-200">
          Getting financial support has never been easier. Follow our simple
          6-step process to access the funding you need.
        </p>
      </div>
    </section>
  );
